...
Make sure to add the `sonner` component inside of your `layout.tsx`.
...
| --------------------- | ------------ | -------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| props                 | uploadthing  | yes      | -       | Accepts all the props that are available with [uploadthing](https://docs.uploadthing.com/api-reference/react#props) <br/><br/> Only the `endpoint` required. <br/><br/>  Note that the `endpoint` isn't typesafe. |
