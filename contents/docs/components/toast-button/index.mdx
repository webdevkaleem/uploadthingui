...
<Tabs defaultValue="pnpm">
    ...
    <TabsContent value="pnpm">
        ```
        pnpm dlx shadcn@latest add http://uploadthingui.vercel.com/r/toast-button.json
        ```
    </TabsContent>
    <TabsContent value="npm">
        ```
        npx shadcn@latest add http://uploadthingui.vercel.com/r/toast-button.json
        ```
    </TabsContent>
    <TabsContent value="yarn">
        ```
        yarn dlx shadcn@latest add http://uploadthingui.vercel.com/r/toast-button.json
        ```
    </TabsContent>
    <TabsContent value="bun">
        ```
        bunx shadcn@latest add http://uploadthingui.vercel.com/r/toast-button.json
        ```
    </TabsContent>
