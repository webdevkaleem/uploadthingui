...
<Tabs defaultValue="pnpm">
    ...
    <TabsContent value="pnpm">
        ```
        pnpm dlx shadcn@latest add https://uploadthingui.webdevkaleem.com/r/toast-button.json
        ```
    </TabsContent>
    <TabsContent value="npm">
        ```
        npx shadcn@latest add https://uploadthingui.webdevkaleem.com/r/toast-button.json
        ```
    </TabsContent>
    <TabsContent value="yarn">
        ```
        yarn dlx shadcn@latest add https://uploadthingui.webdevkaleem.com/r/toast-button.json
        ```
    </TabsContent>
    <TabsContent value="bun">
        ```
        bunx shadcn@latest add https://uploadthingui.webdevkaleem.com/r/toast-button.json
        ```
    </TabsContent>
