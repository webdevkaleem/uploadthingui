...
<Tabs defaultValue="pnpm">
    ...
    <TabsContent value="pnpm">
        ```
        pnpm dlx shadcn@latest add https://uploadthingui.webdevkaleem.com/r/dropzone-dialog.json
        ```
    </TabsContent>
    ...
    <TabsContent value="yarn">
        ```
        yarn dlx shadcn@latest add https://uploadthingui.webdevkaleem.com/r/dropzone-dialog.json
        ```
    </TabsContent>
    <TabsContent value="bun">
        ```
        bunx shadcn@latest add https://uploadthingui.webdevkaleem.com/r/dropzone-dialog.json
        ```
    </TabsContent>
